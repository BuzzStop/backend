...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { lat: @stop.lat, lon: @stop.lon, name: @stop.name, order: @stop.order, route_id: @stop.route_id }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { lat: @stop.lat, lon: @stop.lon, name: @stop.name, order: @stop.order, route_id: @stop.route_id }
    assert_redirected_to stop_path(assigns(:stop))
  end
